...
public class PatentExtract {
	...
	static String inpurDir = "./patents2003/xmls/";
	static String outputDir = "./patents2003/testnewid/";
	...
	public static void main(String[] args) throws IOException {
		...
		FileInputStream nameinputStream = new FileInputStream("./patents2003/dummy");
...
//			        			patent.setTitle(line.substring(line.indexOf("<PDAT>")+6, line.indexOf("</PDAT>")));
			        			patent.setTitle(StringUtils.substringBetween(line, "<PDAT>","</PDAT>").replace("<i>"," ").replace("</i>"," ").replace("<b>"," ").replace("</b>"," ").replace("<sub>"," ").replace("</sub>", " "));
			        	...
			        	// Abstract
							...
							if(abstractText!= null){
								...
								abc = abc.replace("<i>"," ").replace("<b>"," ").replace("</i>"," ").replace("</b>"," ");
								patent.setAbstc(abc);
							}
