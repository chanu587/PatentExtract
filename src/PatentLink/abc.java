...
public class abc {
	...
	static String inpurDir = "./xml/";
	static String outputDir = "./patentsClaim/";
	...
	public static void main(String[] args) throws IOException {
		...
		String line;
		FileInputStream nameinputStream = new FileInputStream("./test1");
...
//			        			patent.setTitle(line.substring(line.indexOf("<PDAT>")+6, line.indexOf("</PDAT>")));
			        	...
			        	//	patent.setAbstc(line.substring(line.indexOf("<PDAT>")+6, line.indexOf("</PDAT>")));
...
//			        				output.write(citystate[0]+separator+citystate[1]+separator);
			...
			for(int i=0;i<patentsList.size();i++){
				...
				//output.write(sample.getId()+separator+sample.getTitle());
